...
let students = [
	...
	'Jungsoo Park',
	'Jim Pinkenberg',
	'Abhishek Gyaneshwar Podichetty',
	'Taylor Rodriguez',
	'Chuyi Sun'
]

students.push('Yiying Xia') // One way to add items to an array.

students[students.length] = 'Chengcheng Xiang' // this also adds and element to the end of the array.

students[30] = 'La Tricia Watford' // This statement will add 'Catherine Schmitz' in the 31st element of the array (index 30!),
